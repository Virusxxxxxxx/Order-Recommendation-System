...
<!-- 										<view class="font-size-extra-sm text-color-assist">
								...
								<view class="d-flex align-items-center mt-40" style="height: 5rpx;">
									<view class="flex-shrink-0 font-weight-bold" style="width: 75%;"></view>
									<view class="flex-shrink-0 font-weight-bold ml-40">
										<button type="default" plain class="service-btn" style="height:25px;border-radius: 10%;vertical-align: middle;line-height: 22px;"
										 @click="toComment(item.product_id, item.sname)">
											评论
										</button>
									</view>
								</view>
